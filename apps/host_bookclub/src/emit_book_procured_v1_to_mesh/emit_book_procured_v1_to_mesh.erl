%% @doc Emitter: each `book_procured_v1' becomes one `book_procured_v1'
%% fact on the mesh.
%%
...
-module(emit_book_procured_v1_to_mesh).
...
handle_event(_EventType, Event, _Metadata, State) ->
    ...
    publish(mcl_bookclub_facts:to_wire(mcl_bookclub_facts:book_procured(Data)),
            State).
